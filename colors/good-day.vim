...
let s:back = ['#ffffff', 233]
let s:default = ['#000000', 137]

let s:margin = ["#181818", 235]
let s:margin_hover = ["#252525", 236]
let s:margin_active = ["#323232", 238]
let s:cursor = ["#00ee00", 83]
let s:highlight = ["#ddee00", 58]
let s:at_highlight = ["#ff44dd", 180]
let s:mark = ["#494949", 244]
let s:comment = ["#2090f0", 244]
let s:keyword = ["#d08f20", 172]
let s:constant = ["a0522d", 64]
let s:preproc = ["#DAB98F", 180]
let s:special = ["#f00000", 196]
let s:bar = ["#888888", 251]
let s:bar_active = ["#666666", 248]
...
call s:HL('StatusLine', s:default, '#bfbfbf')
call s:HL('StatusLineNC', '#333333', '#e5e5e5')
...
call s:HL('LineNr', '#7f7f7f', '#101010')
